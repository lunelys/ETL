...
For example, we can use tMap to unite our 3 tables and handle null values:
...
We fetch only the clients' names, and we then use a tUnite to fetch back the missing data.
